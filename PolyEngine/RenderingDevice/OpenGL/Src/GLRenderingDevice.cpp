	...
	: display(display), window(window)
{
	...
	if (!gladLoadGLX(display, DefaultScreen(display))) {
		Poly::gConsole.LogError("GLDevice: GLAD-GLX initialization failed.");
		throw RenderingDeviceSetupFailedException();
	}
	...
	if (!gladLoadGL()) {
		gConsole.LogError("GLAD initialization failed.");
	}
