...
if (NOT TARGET Vorbis::File)
	...
	set_target_properties(Vorbis::File PROPERTIES INTERFACE_INCLUDE_DIRECTORIES "${VORBISFILE_INCLUDE_DIR}" )

	if(VORBISFILE_LIBRARY)
		set_property(TARGET Vorbis::File APPEND PROPERTY IMPORTED_CONFIGURATIONS RELEASE)
		set_target_properties(Vorbis::File PROPERTIES IMPORTED_LOCATION_RELEASE "${VORBISFILE_LIBRARY}")
	endif()
